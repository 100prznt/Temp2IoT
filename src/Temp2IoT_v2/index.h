...
const char _PAGE_WEBUI_SENSOR1[] PROGMEM = "<h2>Sensor1 %NAME%</h2><p>T = %VALUE% &deg;C</p>";
const char _PAGE_WEBUI_SENSOR2[] PROGMEM = "<h2>Sensor2 %NAME%</h2><p>T = %VALUE% &deg;C</p>";
